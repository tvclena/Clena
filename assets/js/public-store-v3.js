console.info('[CLENA] public-store-v3.js carregado — 20260805-2329');
...
function renderStoreInformation() {
  ...
  for (const id of ['headerInstagram', 'footerInstagram']) {
    ...
    link.classList.toggle('is-hidden', !instagramUrl);
  ...
  if (footerText) {
    footerText.textContent =
      ...
      `${store.name} © ${new Date().getFullYear()}. Todos os direitos reservados.`;
  }
}
